...
$$._HashMapImpl = {"":"Object;_liblib$_keys>,_values,_loadLimit,_numberOfEntries,_numberOfDeleted",
 ...
 _grow$1: function(newCapacity) {
  ...
  for (i = 0; i < capacity; ++i) {
    ...
    $.indexSet(this._liblib$_keys, newIndex, key);
 ...
 clear$0: function() {
  ...
  for (i = 0; i < length$; ++i) {
    $.indexSet(this._liblib$_keys, i, null);
 ...
 operator$indexSet$2: function(key, value) {
  ...
  $.indexSet(this._liblib$_keys, index, key);
...
$$._LinkedHashMapImpl = {"":"Object;_liblib$_list,_liblib$_map",
 operator$indexSet$2: function(key, value) {
  var t1;
  if (this._liblib$_map.containsKey$1(key) === true) {
    ...
    $.indexSet(this._liblib$_map, key, this._liblib$_list.lastEntry$0());
  }
},
 operator$index$1: function(key) {
  var t1, entry;
  t1 = this._liblib$_map;
  if (typeof t1 !== 'string' && (typeof t1 !== 'object' || t1 === null || t1.constructor !== Array && !t1.is$JavaScriptIndexingBehavior()))
    return this.operator$index$1$bailout4(1, key, t1);
  if (key !== (key | 0))
    throw $.iae(key);
 ...
 operator$index$1$bailout4: function(state0, key, t1) {
 ...
 remove$1: function(key) {
  var entry = this._liblib$_map.remove$1(key);
  if (entry == null)
    return;
  entry.remove$0();
  return entry.get$element().get$value();
 ...
 putIfAbsent$2: function(key, ifAbsent) {
  ...
  if (this.operator$index$1(key) == null && this._liblib$_map.containsKey$1(key) !== true) {
    value = ifAbsent.call$0();
    this.operator$indexSet$2(key, value);
  }
  return value;
 ...
 containsKey$1: function(key) {
  return this._liblib$_map.containsKey$1(key);
},
 get$length: function() {
 ...
 _LinkedHashMapImpl$0: function() {
  ...
  this._liblib$_map = $.HashMap_HashMap(t1, [$.DoubleLinkedQueueEntry, [$._KeyValuePair, t2[0], t2[1]]]);
  t3 = $.getRuntimeTypeInfo(this);
  this._liblib$_list = $.DoubleLinkedQueue$([$._KeyValuePair, t3[0], t3[1]]);
},
 is$Map: function() { return true; }
};
...
$$.SequenceList = {"":"SequenceCollection;sequence>",
 ...
 indexOf$2: function(value, start) {
  ...
  while (true) {
    t3 = t2.get$length(t1);
    if (typeof t3 !== 'number')
      return this.indexOf$2$bailout(2, value, t3, i, t1);
    if (!(i < t3))
      break;
...
$$.SequenceIterator = {"":"Object;_sequence,_position",
 ...
 next$0: function() {
  ...
  if (this.get$hasNext() === true) {
    ...
    t4 = this._position;
    if (typeof t4 !== 'number')
      return this.next$0$bailout0(2, t1, t4, t3);
    this._position = t4 + 1;
    if (t4 !== (t4 | 0))
      throw $.iae(t4);
...
$$.EventListenerList = {"":"Object;_ptr>,_liblib1$_type",
 add$2: function(listener, useCapture) {
  this._ptr.$$dom_addEventListener$3(this._liblib1$_type, listener, useCapture);
  return this;
},
 ...
 remove$2: function(listener, useCapture) {
  this._ptr.$$dom_removeEventListener$3(this._liblib1$_type, listener, useCapture);
  return this;
},
...
$$._VariableSizeListIterator = {"":"Object;",
 ...
 next$0: function() {
  ...
  t4 = this._pos;
  if (typeof t4 !== 'number')
    return this.next$0$bailout1(2, t4, t3, t1);
  this._pos = t4 + 1;
  if (t4 !== (t4 | 0))
    throw $.iae(t4);
  if (t4 < 0 || t4 >= t1.length)
...
$$.FilteredElementList = {"":"Object;_liblib10$_node,_childNodes",
...
$$._AttributeClassSet = {"":"CssClassSet;_liblib9$_element>",
 readClasses$0: function() {
  var t1, classname, s, t2, t3, trimmed;
  t1 = this._liblib9$_element.get$attributes();
 ...
 writeClasses$1: function(s) {
  ...
  $.setRuntimeTypeInfo(list, []);
  $.indexSet(this._liblib9$_element.get$attributes(), "class", $.Strings_join(list, " "));
}
};

$$._OnDemandMap = {"":"Object;_creator,_map",
 _creator$0: function() {
 ...
 get$keys: function() {
  var t1 = this._map;
  return !(t1 == null) ? t1.get$keys() : $.CONSTANT14;
},
 get$values: function() {
  var t1 = this._map;
  return !(t1 == null) ? t1.get$values() : $.CONSTANT14;
},
 get$isEmpty: function() {
  var t1 = this._map;
...
$$.VelocityProvider = {"":"Object;_liblib4$_pos,_vel,_time",
 snapshot$2: function(position, time) {
  var diffTime = $.sub(time, this._time);
  if ($.gtB(diffTime, 0)) {
    this._vel = $.div($.sub(position, this._liblib4$_pos), diffTime);
    this._time = time;
    this._liblib4$_pos = position;
  }
},
...
$$.Size = {"":"Object;width>,height>",
 operator$eq$1: function(other) {
  ...
  if (typeof other === 'object' && other !== null && !!other.is$Size)
    t1 = $.eqB(this.get$width(), other.get$width()) && $.eqB(this.get$height(), other.get$height());
  else
    t1 = false;
  return t1;
},
 get$hashCode: function() {
  var t1 = $.add(this.get$width(), this.get$height());
  return $.getInterceptor$JSNumber(t1).toInt$0(t1);
},
 toString$0: function() {
  return "(" + $.S(this.get$width()) + ", " + $.S(this.get$height()) + ")";
},
 is$Size: true
};

$$.Rectangle = {"":"Offset;right>,bottom>,left,top",
 get$width: function() {
 ...
 operator$eq$1: function(other) {
  ...
  if (typeof other === 'object' && other !== null && !!other.is$Rectangle)
    t1 = $.eqB(this.left, other.left) && $.eqB(this.top, other.top) && $.eqB(this.right, other.right) && $.eqB(this.bottom, other.bottom);
  else
    t1 = false;
  return t1;
},
 contains$1: function(offset) {
  ...
  t1 = this.left;
  if (typeof t1 !== 'number')
    return this.contains$1$bailout0(1, offset, t1);
  t2 = offset.get$left();
  if (typeof t2 !== 'number')
    return this.contains$1$bailout0(2, offset, t1, t2);
  t2 = t1 <= t2;
  t1 = t2;
  if (t1) {
    t1 = this.right;
    if (typeof t1 !== 'number')
      return this.contains$1$bailout0(3, offset, t1);
    t2 = offset.get$left();
    if (typeof t2 !== 'number')
      return this.contains$1$bailout0(4, offset, t2, t1);
    t2 = t1 > t2;
    t1 = t2;
    if (t1) {
      t1 = this.top;
      if (typeof t1 !== 'number')
        return this.contains$1$bailout0(5, offset, t1);
      t2 = offset.get$top();
      if (typeof t2 !== 'number')
        return this.contains$1$bailout0(6, offset, t1, t2);
      t2 = t1 <= t2;
      t1 = t2;
      if (t1) {
        t1 = this.bottom;
        if (typeof t1 !== 'number')
          return this.contains$1$bailout0(7, offset, t1);
        t2 = offset.get$top();
        if (typeof t2 !== 'number')
          return this.contains$1$bailout0(8, t2, t1);
        t2 = t1 > t2;
        t1 = t2;
      } else
        t1 = false;
 ...
 snap$1: function(offset) {
  return $.Offset$($.min($.max(offset.get$left(), this.left), this.right), $.min($.max(offset.get$top(), this.top), this.bottom));
},
 get$hashCode: function() {
  var t1 = $.add($.add($.add(this.left, this.top), this.right), this.bottom);
  return $.getInterceptor$JSNumber(t1).toInt$0(t1);
},
 toString$0: function() {
...
$$.View = {"":"Object;_uuid,_parent<,_nextSibling=,_prevSibling=,_virtIS=,_childInfo,_evlInfo>,_dataAttrs<,_mntAttrs,_annos,_style,_node,_left,_top,_width,_height,_profile,_layout,_inDoc",
 ...
 getNode$1: function(subId) {
  var subId0;
  if ($.CONSTANT3.get$isEmpty(subId) === true)
 ...
 shallLayout_$1: function(child) {
  ...
  return $.CONSTANT3.get$isEmpty(v) === true || v === "absolute";
},
 ...
 toString$0: function() {
  ...
  if ($.getInterceptor$JSStringJSArray(t2).get$isEmpty(t2) === true) {
    ...
    t2 = this.get$id();
    if (typeof t2 !== 'string')
      return this.toString$0$bailout1(2, t2, t1);
  }
  return t1 + t2 + ")";
},
 toString$0$bailout1: function(state0, env0, env1) {
  switch (state0) {
    case 1:
      t1 = env1;
      t2 = env0;
...
$$.Declaration = {"":"Object;",
 get$text: function() {
  ...
  t1 = this._props;
  if (typeof t1 !== 'string' && (typeof t1 !== 'object' || t1 === null || t1.constructor !== Array && !t1.is$JavaScriptIndexingBehavior()))
    return this.get$text$bailout(1, t1, sb);
  t3 = t1.get$keys();
  ...
  return t4.toString$0(sb);
},
 get$text$bailout: function(state0, t1, sb) {
  var t3, t4, t5, t2;
  t3 = t1.get$keys();
  t3 = $.getInterceptor$JSArray(t3).iterator$0(t3);
  t4 = $.getInterceptor$JSArray(sb);
  t5 = $.getInterceptor$JSStringJSArray(t1);
  for (; t3.get$hasNext() === true;) {
    t2 = t3.next$0();
    t4.add$1(sb, t2);
    t4.add$1(sb, ":");
    t4.add$1(sb, t5.operator$index$1(t1, t2));
    t4.add$1(sb, ";");
  }
...
$$._EventListenerInfo = {"":"Object;_owner,on>,_listeners,_domListeners",
 ...
 send$2$type: function(event$, type) {
  ...
  t1 = this._listeners;
  if (typeof t1 !== 'string' && (typeof t1 !== 'object' || t1 === null || t1.constructor !== Array && !t1.is$JavaScriptIndexingBehavior()))
    return this.send$2$type$bailout(1, event$, type, t1);
  if (type !== (type | 0))
    throw $.iae(type);
 ...
 send$2$type$bailout: function(state0, event$, type, t1) {
  var ls, dispatched;
  if (!(t1 == null)) {
    ls = $.getInterceptor$JSStringJSArray(t1).operator$index$1(t1, type);
    t1 = !(ls == null);
...
$$._StyleImpl = {"":"Object;_view",
 ...
 get$transition: function() {
  return this.get$_st().get$transition();
},
...
$$.Image = {"":"View;_uuid,_parent,_nextSibling,_prevSibling,_virtIS,_childInfo,_evlInfo,_dataAttrs,_mntAttrs,_annos,_style,_node,_left,_top,_width,_height,_profile,_layout,_inDoc",
 get$src: function() {
 ...
 measureWidth_$1: function(mctx) {
  return mctx.measureContentWidth$2(this, false);
},
 measureHeight_$1: function(mctx) {
  return mctx.measureContentHeight$2(this, false);
},
 mount_$0: function() {
 ...
 Image$1: function(src) {
  if (!(src == null) && $.getInterceptor$JSStringJSArray(src).get$isEmpty(src) !== true)
    this.get$imageNode().set$src(src);
}
};

$$.ScrollView = {"":"View;_snap,direction,_scroller,_contentSizeValue,_contentSize,_uuid,_parent,_nextSibling,_prevSibling,_virtIS,_childInfo,_evlInfo,_dataAttrs,_mntAttrs,_annos,_style,_node,_left,_top,_width,_height,_profile,_layout,_inDoc",
 _snap$1: function(arg0) {
  return this._snap.call$1(arg0);
},
 get$viewPortSize: function() {
  return $.DomAgent$(this.get$node()).get$innerSize();
},
 get$contentSize: function() {
  var t1, r;
  if (this._contentSize == null) {
    t1 = this._contentSizeValue;
    if (!(t1 == null))
      this._contentSize = t1;
    else {
      r = $.ViewUtil_getRectangle(this.get$children());
      this._contentSize = $.Size$(r.get$width(), r.get$height());
    }
  }
 ...
 newScroller_$0: function() {
  ...
  t1 = this.get$contentNode();
  t2 = new $.ScrollView_newScroller__anon(this);
  t3 = new $.ScrollView_newScroller__anon0(this);
  t4 = this.direction;
  t5 = this._snap;
  t6 = this.get$onScrollStart_();
  t7 = this.get$onScrollMove_();
  return $.Scroller$(t1, t2, t3, t4, this.get$onScrollEnd_(), null, t7, true, t5, t6);
},
 ...
 get$onScrollStart_: function() {
  return new $.BoundClosure0(this, 'onScrollStart_$1');
},
 onScrollMove_$2: function(state, defaultAction) {
  defaultAction.call$0();
  this.sendEvent$1($.ScrollEvent$("scrollMove", this, state));
  return true;
},
 get$onScrollMove_: function() {
  return new $.BoundClosure3(this, 'onScrollMove_$2');
},
 onScrollEnd_$1: function(state) {
  this.sendEvent$1($.ScrollEvent$("scrollEnd", this, state));
},
 get$onScrollEnd_: function() {
  return new $.BoundClosure0(this, 'onScrollEnd_$1');
},
 onPreLayout_$1: function(mctx) {
  var sz, style;
  this._contentSize = null;
  sz = this.get$contentSize();
  style = this.get$contentNode().get$style();
 ...
 render_$0: function() {
  return $.Element_Element$html("<div><div class=\"v-inner\" id=\"" + $.S(this.get$uuid()) + "-inner\"></div></div>");
},
 addChildNode_$2: function(child, beforeChild) {
  var t1;
  if (!(beforeChild == null))
    ...
    t1 = this.get$contentNode().get$nodes();
    $.getInterceptor$JSArray(t1).add$1(t1, child.get$node());
  }
}
};
...
$$.ViewEvent = {"":"Object;_type,_stamp,_propStop,target=,currentTarget<",
...
$$.DomEvent = {"":"ViewEvent;cause,_type,_stamp,_propStop,target,currentTarget",
 get$pageOffset: function() {
  return $.Offset$(0, 0);
},
 get$timeStamp: function() {
...
$$._UiEvent = {"":"DomEvent;cause,_type,_stamp,_propStop,target,currentTarget",
 get$_uc: function() {
  return this.cause;
},
 get$pageOffset: function() {
...
$$._KbEvent = {"":"_UiEvent;cause,_type,_stamp,_propStop,target,currentTarget",
 toString$0: function() {
  return "KeyboardEvent(" + $.S(this.target) + "," + $.S(this.cause) + ")";
}
};

$$._MsEvent = {"":"_UiEvent;cause,_type,_stamp,_propStop,target,currentTarget",
 toString$0: function() {
  return "MouseEvent(" + $.S(this.target) + "," + $.S(this.cause) + ")";
}
};

$$.ActivateEvent = {"":"ViewEvent;_source,_type,_stamp,_propStop,target,currentTarget",
 get$source: function() {
  return this._source;
},
...
$$.ChangeEvent = {"":"ViewEvent;_value,_type,_stamp,_propStop,target,currentTarget",
 get$value: function() {
  return this._value;
},
 toString$0: function() {
...
$$.LayoutEvent = {"":"ViewEvent;_context,_type,_stamp,_propStop,target,currentTarget",
 toString$0: function() {
  return "LayoutEvent(" + $.S(this.target) + ")";
}
};

$$.ScrollEvent = {"":"ViewEvent;state,_type,_stamp,_propStop,target,currentTarget"
};

$$.ViewEventListenerList = {"":"Object;_liblib3$_ptr>,_type",
 add$1: function(handler) {
  this._liblib3$_ptr.add$2(this._type, handler);
  return this;
},
 remove$1: function(handler) {
  this._liblib3$_ptr.remove$2(this._type, handler);
  return this;
},
 get$isEmpty: function() {
  var t1 = this._liblib3$_ptr;
  return $.getInterceptor$JSStringJSArray(t1).isEmpty$1(t1, this._type);
},
 isEmpty$1: function(arg0) {
  return this.get$isEmpty().call$1(arg0);
}
...
$$.ViewEventListenerMap = {"":"Object;_liblib3$_ptr>",
 operator$index$1: function(type) {
...
$$.ViewEvents = {"":"ViewEventListenerMap;_liblib3$_ptr,_lnlist",
 get$click: function() {
...
$$.BroadcastEvents = {"":"ViewEventListenerMap;_liblib3$_ptr,_lnlist"
};

$$._Broadcaster = {"":"Broadcaster;_liblib3$_listeners,_on",
 get$on: function() {
  return this._on;
},
 sendEvent$2$type: function(event$, type) {
  return this._liblib3$_listeners.send$2$type(event$, type);
},
 sendEvent$1: function(event$) {
  return this.sendEvent$2$type(event$, null);
},
 _Broadcaster$0: function() {
  this._liblib3$_listeners = $._BroadcastListeners$(this);
  this._on = $.BroadcastEvents$(this._liblib3$_listeners);
}
};

$$._BroadcastListeners = {"":"Object;_liblib3$_owner,_liblib3$_listeners",
 isEmpty$1: function(type) {
  var t1, ls;
 ...
 add$2: function(type, listener) {
  ...
  if (listener == null)
    throw $.$$throw($.ArgumentError$("listener"));
  t1 = this._liblib3$_listeners.putIfAbsent$2(type, new $._BroadcastListeners_add_anon());
 ...
 send$2$type: function(event$, type) {
  ...
  t1 = this._liblib3$_listeners;
  if (typeof t1 !== 'string' && (typeof t1 !== 'object' || t1 === null || t1.constructor !== Array && !t1.is$JavaScriptIndexingBehavior()))
    return this.send$2$type$bailout0(1, event$, t1, type);
  if (type !== (type | 0))
    throw $.iae(type);
  if (type < 0 || type >= t1.length)
    throw $.ioore(type);
 ...
 send$2$type$bailout0: function(state0, event$, t1, type) {
  var ls, dispatched;
  ls = $.getInterceptor$JSStringJSArray(t1).operator$index$1(t1, type);
  if (!(ls == null))
    for (t1 = $.List_List$from(ls), $.setRuntimeTypeInfo(t1, []), t1 = $.CONSTANT0.iterator$0(t1), dispatched = false; t1.get$hasNext() === true; dispatched = true) {
...
$$.DomAgent = {"":"Object;node>",
 ...
 get$contentWidth: function() {
  return this.node.get$scrollWidth();
},
 get$contentHeight: function() {
  return this.node.get$scrollHeight();
},
 get$contentSize: function() {
  return $.Size$(this.get$contentWidth(), this.get$contentHeight());
},
...
$$.LayoutManager = {"":"RunOnceViewManager;_layouts,_imgWaits>,_afters,_inLayout,_inCallback=,_runQue,_views,_liblib7$_task,_readyChecks,_ignoreDetached,_ignoreSubviews",
 ...
 waitImageLoaded$1: function(imgURI) {
  var t1, t2, img, func;
  if (!(imgURI == null))
    if ($.getInterceptor$JSStringJSArray(imgURI).get$isEmpty(imgURI) !== true) {
      t1 = this._imgWaits;
      t2 = $.getInterceptor$JSStringJSArray(t1).contains$1(t1, imgURI) !== true;
      t1 = t2;
    } else
      t1 = false;
  else
...
$$.MeasureContext = {"":"Object;widths,heights,_borderWds,_borderHghs,_liblib8$_dataAttrs<",
 ...
 get$dataAttributes: function() {
  var t1 = this._liblib8$_dataAttrs;
...
$$._HLayout = {"":"_LinearHandler;",
  ...
  for (t1 = view.get$children(), t1 = $.getInterceptor$JSArray(t1).iterator$0(t1), width = 0, prevSpacing = null; t1.get$hasNext() === true;) {
    ...
    switch (amt.type) {
      ...
      case $.CONSTANT19:
        ...
        wd = !(wapp == null) && !$.eqB(amt.type, $.CONSTANT19) ? wapp : t2.measureWidth_$1(mctx);
  ...
  for (t1 = view.get$children(), t1 = $.getInterceptor$JSArray(t1).iterator$0(t1), height = null; t1.get$hasNext() === true;) {
    ...
    switch (amt.type) {
      ...
      case $.CONSTANT19:
        ...
        h = !(happ == null) && !$.eqB(amt.type, $.CONSTANT19) ? happ : t2.measureHeight_$1(mctx);
 ...
 doLayout$3: function(mctx, view, children) {
  var spcinf, gapinf, defpwd, childspcinfs, flexViews, flexs, t1, nflex, assigned, prevSpacing, t2, si, t3, pwd, amt, wdapp, wd, space, per, len, j, delta, defAlign, t4, align;
  spcinf = $.SideInfo$(view.get$layout().get$spacing(), $.get$_SPACING(), null);
  gapinf = $.SideInfo$(view.get$layout().get$gap(), null, null);
  defpwd = view.get$layout().get$width();
  ...
  for (t1 = $.CONSTANT0.iterator$0(children), t2 = $.getInterceptor$JSStringJSArray(childspcinfs), assigned = 0, prevSpacing = null; t1.get$hasNext() === true;) {
    t3 = t1.next$0();
 ...
 measureHeight$2: function(mctx, view) {
  ...
  for (t1 = view.get$children(), t1 = $.getInterceptor$JSArray(t1).iterator$0(t1), height = 0, prevSpacing = null; t1.get$hasNext() === true;) {
    ...
    switch (amt.type) {
      ...
      case $.CONSTANT19:
        happ = mctx.getHeightByApp$1(t2);
        hgh = !(happ == null) && !$.eqB(amt.type, $.CONSTANT19) ? happ : t2.measureHeight_$1(mctx);
 ...
 measureWidth$2: function(mctx, view) {
  ...
  for (t1 = view.get$children(), t1 = $.getInterceptor$JSArray(t1).iterator$0(t1), width = null; t1.get$hasNext() === true;) {
    ...
    switch (amt.type) {
      ...
      case $.CONSTANT19:
        wapp = mctx.getWidthByApp$1(t2);
        w = !(wapp == null) && !$.eqB(amt.type, $.CONSTANT19) ? wapp : t2.measureWidth_$1(mctx);
...
$$.RunOnceViewManager = {"":"Object;",
 _liblib7$_task$1: function(arg0) {
  return this._liblib7$_task.call$1(arg0);
},
 ...
 flush$2: function(view, force) {
  var t1;
  if (this._liblib7$_ready$2(view, force) !== true) {
    if (!(view == null)) {
      t1 = this._views;
      $.getInterceptor$JSArray(t1).add$1(t1, view);
    }
 ...
 _liblib7$_ready$2: function(view, force) {
  var t1, continueTask;
...
$$.DragGestureState = {"":"GestureState;_gesture,_vp,_liblib5$_position,_liblib5$_time,eventTarget>,startTime,startPosition>,data",
 get$time: function() {
  return this._liblib5$_time;
},
 get$position: function() {
  return this._liblib5$_position;
},
 get$transition: function() {
  return $.sub(this._liblib5$_position, this.startPosition);
},
 get$velocity: function() {
  return this._vp.get$velocity();
},
 snapshot$2: function(position, time) {
  this._vp.snapshot$2(position, time);
  this._liblib5$_position = position;
  this._liblib5$_time = time;
}
};

$$.DragGesture = {"":"Gesture;_move>,_end>,_state=",
 _start$1: function(arg0) {
  return this._start.call$1(arg0);
},
 _start$1: function(arg0) {
  return this._start.call$1(arg0);
},
 _move$1: function(arg0) {
  return this._move.call$1(arg0);
},
 _move$2: function(arg0, arg1) {
  return this._move.call$2(arg0, arg1);
},
 _move$1: function(arg0) {
  return this._move.call$1(arg0);
},
 _end$0: function() {
  return this._end.call$0();
},
 _end$1: function(arg0) {
  return this._end.call$1(arg0);
},
 _end$1: function(arg0) {
  return this._end.call$1(arg0);
},
 ...
 get$destroy: function() {
  return new $.BoundClosure(this, 'destroy$0');
},
 stop$0: function() {
  this._state = null;
},
 _touchStart$3: function(target, position, time) {
  if (this._disabled)
    return;
  this.stop$0();
  this._state = $.DragGestureState$_(this, target, position, time);
...
$$._TouchDragGesture = {"":"DragGesture;_elStart,_elMove,_elEnd,_start,_move,_end,_state,_disabled,owner",
 _listen$0: function() {
  var on, t1, t2, t3;
...
$$._MouseDragGesture = {"":"DragGesture;_elStart,_elMove,_elEnd,_captured,_start,_move,_end,_state,_disabled,owner",
 stop$0: function() {
  if (this._captured) {
...
$$.Scroller = {"":"Object;_hasHor>,_hasVer>,scrollbar,_start,_move>,_end>,_fnContentSize,_fnViewPortSize,_dg,_bim<,_stm,_state=,_scrollbarCtrl,direction,owner,handle",
 _start$1: function(arg0) {
  return this._start.call$1(arg0);
},
 _start$1: function(arg0) {
 ...
 _fnContentSize$0: function() {
  return this._fnContentSize.call$0();
},
 _fnViewPortSize$0: function() {
  return this._fnViewPortSize.call$0();
},
 stop$0: function() {
  var t1 = this._bim;
  if (!(t1 == null)) {
 ...
 destroy$0: function() {
  this._state = null;
  if (this.scrollbar === true && !(this._scrollbarCtrl == null)) {
    var t1 = this._scrollbarCtrl.get$destroy();
 ...
 _onStart$3: function(target, time, callback) {
  var t1, res;
  t1 = this._bim;
  if (!(t1 == null))
    t1.stop$0();
  this._state = $.ScrollerState$_(this, target, this._fnViewPortSize, this._fnContentSize, time);
  if (this.scrollbar === true && !(this._scrollbarCtrl == null))
    this._applyScrollBarFunction1$2(this._scrollbarCtrl.get$start(), this._state);
  if (callback !== true || this._start == null)
    return true;
  res = this._start$1(this._state);
  return res == null || res === true;
},
 _onStart$2: function(target, time) {
  return this._onStart$3(target, time, true);
},
 _onMove$3: function(position, time, callback) {
  this._state.snapshot$2(position, time);
  if (this.scrollbar === true && !(this._scrollbarCtrl == null))
    this._applyScrollBarFunction1$2(this._scrollbarCtrl.get$move(), this._state);
  if (callback === true && !(this._move == null)) {
    if (this._move$2(this._state, new $.Scroller__onMove_anon(this, position)) === false)
      ;
  } else
    this._applyPosition$1(position);
},
 _onMove$2: function(position, time) {
  return this._onMove$3(position, time, true);
},
 get$_onMove: function() {
  return new $.BoundClosure4(this, '_onMove$3');
},
 _onEnd$1: function(callback) {
  if (callback === true && !(this._end == null))
    this._end$1(this._state);
  if (this.scrollbar === true && !(this._scrollbarCtrl == null))
    this._applyScrollBarFunction1$2(this._scrollbarCtrl.get$end(), this._state);
  this._state = null;
  this._bim = null;
},
 get$_onEnd: function() {
  return new $.BoundClosure5(this, '_onEnd$1');
},
 _applyPosition$1: function(position) {
  var t1;
  if (this.get$_hor() === true) {
    t1 = $.Css_px(position.get$left());
 ...
 get$_applyPosition: function() {
  return new $.BoundClosure0(this, '_applyPosition$1');
},
 _scrollbarControl$0: function() {
  return $.ScrollbarControl$(this, this.owner);
},
 ...
 Scroller$10$direction$end$handle$move$scrollbar$snap$start: function(owner, viewPortSize, contentSize, direction, end, handle, move, scrollbar, snap, start) {
  var t1, t2, t3;
  t1 = !(handle == null) ? handle : owner;
  t2 = new $.anon(this);
  t3 = new $.anon0(this);
  this._dg = $.DragGesture_DragGesture(t1, new $.anon1(this, owner, snap), t3, t2);
  if (scrollbar === true) {
    this._scrollbarCtrl = this._scrollbarControl$0();
    t1 = this._scrollbarCtrl;
    if (!(t1 == null))
      this._applyScrollBarFunction0$1(t1.get$init());
  }
}
};

$$.ScrollerState = {"":"GestureState;_fnViewPortSize,_fnContentSize,_hor>,_ver>,_liblib5$_pos,_ppos,_liblib5$_time,_ptime,_contentSizeCache,_viewPortSizeCache,_dragRangeCache,eventTarget>,scroller,startPosition>,data",
 _fnViewPortSize$0: function() {
  return this._fnViewPortSize.call$0();
},
 _fnContentSize$0: function() {
 ...
 get$position: function() {
  return this._liblib5$_pos;
},
 get$velocity: function() {
  var t1 = this._ppos;
  return t1 == null || this._liblib5$_pos == null || this._liblib5$_time == null || this._ptime == null ? $.Offset$(0, 0) : $.div($.sub(this._liblib5$_pos, t1), $.sub(this._liblib5$_time, this._ptime));
},
 get$viewPortSize: function() {
  if (this._viewPortSizeCache == null)
    this._viewPortSizeCache = this._fnViewPortSize$0();
  return this._viewPortSizeCache;
},
 get$contentSize: function() {
  if (this._contentSizeCache == null)
    this._contentSizeCache = this._fnContentSize$0();
 ...
 get$resize: function() {
  return new $.BoundClosure(this, 'resize$0');
},
 get$dragRange: function() {
  var vsize, csize;
  if (this._dragRangeCache == null) {
    vsize = this.get$viewPortSize();
    csize = this.get$contentSize();
    this._dragRangeCache = $.Rectangle$($.sub(vsize.get$width(), csize.get$width()), $.sub(vsize.get$height(), csize.get$height()), 0, 0);
  }
  return this._dragRangeCache;
},
 snapshot$2: function(pos, time) {
  var t1 = this._liblib5$_time;
  if (t1 == null || $.gtB(time, t1)) {
    this._ppos = this._liblib5$_pos;
    this._ptime = this._liblib5$_time;
    this._liblib5$_pos = $.mul(pos, -1);
    this._liblib5$_time = time;
  }
},
 ScrollerState$_$5: function(scroller, eventTarget, _fnViewPortSize, _fnContentSize, _time) {
  var cs, vs;
  this._liblib5$_pos = this.startPosition;
  cs = this.get$contentSize();
  vs = this.get$viewPortSize();
...
$$.ScrollbarControl = {"":"Object;_hbar,_vbar,scroller,owner",
 init$1: function(vertical) {
  var t1, t2;
  t1 = vertical === true;
  t2 = this.owner;
  if (t1) {
    this._vbar = $.Element_Element$tag("div");
    t1 = ["v-scrollbar-ver"];
    ...
    this._hbar = $.Element_Element$tag("div");
    t1 = ["v-scrollbar-hor"];
 ...
 get$init: function() {
  return new $.BoundClosure0(this, 'init$1');
},
 ...
 get$destroy: function() {
  return new $.BoundClosure0(this, 'destroy$1');
},
 ...
 get$start: function() {
  return new $.BoundClosure3(this, 'start$2');
},
 move$2: function(vertical, state) {
  this._updateBarPosition$2(vertical, state);
},
 get$move: function() {
  return new $.BoundClosure3(this, 'move$2');
},
 end$2: function(vertical, state) {
  (vertical === true ? this._vbar : this._hbar).get$style().set$display("none");
},
 get$end: function() {
  return new $.BoundClosure3(this, 'end$2');
},
 _updateBarSize$2: function(ver, state) {
  var csize, vsize, t1, csize0, vsize0, t2, s, off;
  csize = state.get$contentSize();
  vsize = state.get$viewPortSize();
  t1 = ver === true;
  csize0 = t1 ? csize.get$height() : csize.get$width();
  vsize0 = t1 ? vsize.get$height() : vsize.get$width();
  t2 = $.sub(vsize0, 4);
  t2 = $.mul(t2, $.gtB(csize0, vsize0) ? $.div(vsize0, csize0) : 1);
  s = $.sub($.getInterceptor$JSNumber(t2).toInt$0(t2), 2);
  off = $.sub($.sub($.sub(t1 ? vsize.get$width() : vsize.get$height(), 2), 4), 2);
  if (t1) {
    t1 = $.Css_px(s);
 ...
 _updateBarPosition$2: function(ver, state) {
  var csize, vsize, t1, csize0, vsize0, pos, t2, x;
  csize = state.get$contentSize();
  vsize = state.get$viewPortSize();
  t1 = ver === true;
  csize0 = t1 ? csize.get$height() : csize.get$width();
  vsize0 = t1 ? vsize.get$height() : vsize.get$width();
  pos = t1 ? state.get$position().get$y() : state.get$position().get$x();
  t2 = $.gtB(csize0, vsize0) ? $.div($.mul($.sub(vsize0, 4), pos), csize0) : 0;
  if (typeof t2 !== 'number')
    throw $.iae(t2);
  x = 2 + t2;
  if (t1) {
...
$$._BoundedInertialMotion = {"":"Motion;_hor>,_ver>,element>,friction,bounce,snapSpeedThreshold,range,_move>,_end>,_liblib5$_snap,_posx,_posy,_velx,_vely,_snapMotion,_snapTo,_liblib6$_start,_liblib6$_move,_liblib6$_end,_task,_liblib6$_state,_stateFlag",
 _move$1: function(arg0) {
  return this._move.call$1(arg0);
},
 _move$2: function(arg0, arg1) {
 ...
 _liblib5$_snap$1: function(arg0) {
  return this._liblib5$_snap.call$1(arg0);
},
 onMove$1: function(state) {
  var vel, speed, dir, dec, elapsed, t1, t2, t3, t4, t5, t6;
  vel = $.Offset$(this._velx, this._vely);
  speed = vel.norm$0();
  dir = $.eqB(speed, 0) ? $.Offset$(0, 0) : vel.operator$div$1(speed);
  dec = $.mul(dir, this.friction);
  elapsed = state.get$elapsedTime();
  t1 = this._hor === true;
  if (t1) {
    t2 = this._posx;
    t3 = this._velx;
    t4 = dec.get$x();
    t5 = this.range;
    this._posx = this._updatePosition$6(t2, t3, t4, elapsed, t5.get$x(), t5.get$right());
  }
  t2 = this._ver === true;
  if (t2) {
    t3 = this._posy;
    ...
    t5 = dec.get$y();
    t6 = this.range;
    this._posy = this._updatePosition$6(t3, t4, t5, elapsed, t6.get$y(), t6.get$bottom());
  }
  if (!(this._move == null))
    this._move$2($.Offset$(this._posx, this._posy), state.get$currentTime());
  if (t1) {
    t3 = this._posx;
    t4 = this._velx;
    t5 = dec.get$x();
    t6 = this.range;
    this._velx = this._updateVelocity$6(t3, t4, t5, elapsed, t6.get$x(), t6.get$right());
  }
  if (t2) {
    t3 = this._posy;
    t4 = this._vely;
    t5 = dec.get$y();
    t6 = this.range;
    this._vely = this._updateVelocity$6(t3, t4, t5, elapsed, t6.get$y(), t6.get$bottom());
  }
  if (this._shallSnap$0() === true)
    return false;
  if (t1) {
    t1 = this._posx;
    t3 = this._velx;
    ...
    t5 = t4.get$x();
    t4 = t4.get$right();
    t1 = !($.leB(t5, t1) && $.leB(t1, t4) && $.eqB(t3, 0));
  } else
    t1 = false;
  if (!t1)
    if (t2) {
      ...
      t4 = t3.get$y();
      t3 = t3.get$bottom();
      t1 = !($.leB(t4, t1) && $.leB(t1, t3) && $.eqB(t2, 0));
    } else
      t1 = false;
  else
    t1 = true;
 ...
 onEnd$1: function(state) {
  ...
  if (!(this._snapTo == null)) {
    t1 = this.element;
    t2 = $.Offset$(this._posx, this._posy);
    t3 = this._snapTo;
    t4 = new $._BoundedInertialMotion_onEnd_anon(this);
    t5 = new $._BoundedInertialMotion_onEnd_anon0(this);
    t4 = $.LinearPathMotion$(t1, t2, t3, new $._BoundedInertialMotion_onEnd_anon1(), t5, t4, 200, null);
    t4.run$0();
    this._snapMotion = t4;
 ...
 _updatePosition$6: function(pos, vel, dec, elap, lbnd, rbnd) {
  ...
  if ($.ltB(pos, lbnd) && $.gtB(npos, lbnd) && $.gtB(vel, 0))
    return lbnd;
  else if ($.gtB(pos, rbnd) && $.ltB(npos, rbnd) && $.ltB(vel, 0))
    return rbnd;
  return npos;
},
 _updateVelocity$6: function(pos, vel, dec, elap, lbnd, rbnd) {
  ...
  if (!($.eqB(pos, lbnd) && $.gtB(vel, 0)))
    t1 = $.eqB(pos, rbnd) && $.ltB(vel, 0);
  else
    t1 = true;
  if (t1)
    return 0;
  if ($.ltB(pos, lbnd))
    acc = $.mul($.sub(lbnd, pos), this.bounce);
  else
    acc = $.gtB(pos, rbnd) ? $.mul($.sub(rbnd, pos), this.bounce) : $.neg(dec);
  nvel = $.add(vel, $.mul(acc, elap));
 ...
 _shallSnap$0: function() {
  var t1, t2, t3, scrPos, scrSnapPos, scrSnapPos0;
  if (!(this._liblib5$_snap == null)) {
    t1 = this._velx;
    t1 = $.getInterceptor$JSNumber(t1).abs$0(t1);
    t2 = this._vely;
    t3 = $.gtB($.max(t1, $.getInterceptor$JSNumber(t2).abs$0(t2)), this.snapSpeedThreshold);
    t1 = t3;
  } else
    t1 = true;
  if (t1)
  ...
  if (t1) {
    t2 = this._posx;
    t3 = this.range;
    t2 = $.ltB(t2, t3.get$x()) || $.gtB(this._posx, t3.get$right());
  } else
    t2 = true;
  if (t2)
    if (this._ver === true) {
      t2 = this._posy;
      t3 = this.range;
      t2 = $.ltB(t2, t3.get$y()) || $.gtB(this._posy, t3.get$bottom());
    } else
      t2 = true;
  else
    t2 = false;
  if (t2)
    return false;
  scrPos = $.Offset$($.neg(this._posx), $.neg(this._posy));
  scrSnapPos = this._liblib5$_snap$1(scrPos);
  if (scrSnapPos == null)
    return false;
  scrSnapPos0 = $.mul(this.range.snap$1($.mul(scrSnapPos, -1)), -1);
 ...
 _BoundedInertialMotion$11$bounce$friction$snap$snapSpeedThreshold: function(element, velocity, range, _hor, _ver, move, end, bounce, friction, snap, snapSpeedThreshold) {
  var pos = $.DomAgent$(element).get$offset();
  this._posx = pos.get$x();
  this._posy = pos.get$y();
  this._velx = this._hor === true ? velocity.get$x() : 0;
  this._vely = this._ver === true ? velocity.get$y() : 0;
}
};

$$._Animator = {"":"Object;_liblib6$_tasks>,_tmpRemoved<,_callback>",
 _afterCallback$0: function() {
  var removed, t1;
  removed = this._tmpRemoved;
  this._tmpRemoved = null;
  for (t1 = $.getInterceptor$JSArray(removed).iterator$0(removed); t1.get$hasNext() === true;)
    this.remove$1(t1.next$0());
},
 _isRemoved$1: function(index) {
  ...
  if ($.getInterceptor$JSStringJSArray(t1).get$isEmpty(t1) !== true) {
    ...
    if (index < 0 || index >= t1.length)
      throw $.ioore(index);
    task = t1[index];
    for (t2 = this._tmpRemoved, t2 = $.getInterceptor$JSArray(t2).iterator$0(t2), cnt = 0; t2.get$hasNext() === true;)
 ...
 remove$1: function(task) {
  ...
  if (!(t1 == null))
    $.getInterceptor$JSArray(t1).add$1(t1, task);
  else
    $.ListUtil_remove(this._liblib6$_tasks, task);
},
 _Animator$0: function() {
  this._callback = new $.anon2(this);
}
};

$$.MotionState = {"":"Object;startTime,_current,_elapsed,_paused,_pauseStart,data",
...
$$.Motion = {"":"Object;_liblib6$_move>,_liblib6$_end>,_liblib6$_state=,_stateFlag=",
 _liblib6$_start$1: function(arg0) {
  return this._liblib6$_start.call$1(arg0);
},
 _liblib6$_start$1: function(arg0) {
  return this._liblib6$_start.call$1(arg0);
},
 _liblib6$_move$1: function(arg0) {
  return this._liblib6$_move.call$1(arg0);
},
 _liblib6$_move$2: function(arg0, arg1) {
  return this._liblib6$_move.call$2(arg0, arg1);
},
 _liblib6$_move$1: function(arg0) {
  return this._liblib6$_move.call$1(arg0);
},
 _liblib6$_end$0: function() {
  return this._liblib6$_end.call$0();
},
 _liblib6$_end$1: function(arg0) {
  return this._liblib6$_end.call$1(arg0);
},
 _liblib6$_end$1: function(arg0) {
  return this._liblib6$_end.call$1(arg0);
},
 ...
 onStart$1: function(state) {
  if (!(this._liblib6$_start == null))
    this._liblib6$_start$1(state);
},
 onMove$1: function(state) {
  return this._liblib6$_move == null || this._liblib6$_move$1(state) === true;
},
 onEnd$1: function(state) {
  if (!(this._liblib6$_end == null))
    this._liblib6$_end$1(state);
},
 ...
 run$0: function() {
  switch (this._stateFlag) {
    ...
    case 0:
      ...
      $.getInterceptor$JSArray(t1).add$1(t1, this._task);
      break;
  }
},
 stop$0: function() {
  this.get$animator().remove$1(this._task);
  this._liblib6$_state = null;
  this._stateFlag = 0;
},
 get$isPaused: function() {
 ...
 Motion$3$end$move$start: function(end, move, start) {
  this._task = new $.anon3(this);
}
};

$$.EasingMotion = {"":"Motion;",
 action$2: function(arg0, arg1) {
  return this.action.call$2(arg0, arg1);
},
 easing$1: function(arg0) {
  return this.easing.call$1(arg0);
},
...
$$.LinearPathMotion = {"":"EasingMotion;element>,_moveCB,origin,destination,_diff,_liblib6$_pos,action,easing,period,repeat,duration,_liblib6$_start,_liblib6$_move,_liblib6$_end,_task,_liblib6$_state,_stateFlag",
 _moveCB$4: function(arg0, arg1, arg2, arg3) {
  return this._moveCB.call$4(arg0, arg1, arg2, arg3);
},
 doAction_$2: function(x, state) {
  var t1, t2;
  this._liblib6$_pos = $.add($.mul(this._diff, x), this.origin);
  if (this._moveCB == null) {
    t1 = $.Css_px(this._liblib6$_pos.get$left());
    t2 = this.element;
    t2.get$style().set$left(t1);
    t1 = $.Css_px(this._liblib6$_pos.get$top());
    t2.get$style().set$top(t1);
    return true;
  }
  return !(this._moveCB$4(state, this._liblib6$_pos, x, this.get$_liblib6$_applyPosition()) === false);
},
 _liblib6$_applyPosition$0: function() {
  var t1, t2;
  t1 = $.Css_px(this._liblib6$_pos.get$left());
  t2 = this.element;
  t2.get$style().set$left(t1);
 ...
 get$_liblib6$_applyPosition: function() {
  return new $.BoundClosure(this, '_liblib6$_applyPosition$0');
}
};
...
$$.SimpleSelectorSequence = {"":"Object;type=,id=,classes>,attributes,pseudoClasses>,combinator>",
 ...
 toString$0$bailout0: function(state0, env0) {
  switch (state0) {
    case 1:
      t1 = env0;
      break;
  ...
  switch (state0) {
    ...
    case 1:
      var sb, t1, t2;
      if (state0 === 0 && t1.get$isEmpty(sb) === true)
        t1 = "*";
      else
        switch (state0) {
          case 0:
...
$$.ViewIterator = {"":"Object;_root,_selectors,_posOffset,_allIds,_offsetRoot,_currCtx,_ready,_liblib2$_next=,_liblib2$_index",
 ...
 get$hasNext: function() {
  this._loadNext$0();
  return !(this._liblib2$_next == null);
},
 _loadNext$0: function() {
  if (this._ready)
    return;
  this._liblib2$_next = this._seekNext$0();
  this._ready = true;
},
 _seekNext$0: function() {
  this._currCtx = this._liblib2$_index < 0 ? this._buildRootCtx$0() : this._buildNextCtx$0();
  while (true) {
...
$$.AIBSImage = {"":"Object;aibsID>,dataSetID,expressionPath,imagePath,imageWidth,imageHeight,resolution,sectionNumber,structureID,tierCount,queryURL,imageServerBaseURL,zoomifyThumbnailBase"
};

$$.ImageCollection = {"":"Object;imageSeriesList>,delegate,queryURL",
 delegate$0: function() {
  return this.delegate.call$0();
},
 queryJSONFromAIBS$0: function() {
  $.HttpRequest_HttpRequest$get(this.queryURL, this.get$onSuccess());
  return true;
},
 onSuccess$1: function(req) {
  var parsedMap, t1, responseList, sds, listOfImages, t2, imageToAdd, t3;
  $.print("Success");
  parsedMap = $.JSON_parse(req.get$responseText());
  t1 = $.getInterceptor$JSStringJSArray(parsedMap);
  $.print("There are " + $.S(t1.operator$index$1(parsedMap, "total_rows")) + " results for the AIBS api query.");
  responseList = t1.operator$index$1(parsedMap, "msg");
  t1 = $.getInterceptor$JSStringJSArray(responseList);
  $.print(t1.get$length(responseList));
  sds = t1.operator$index$1(responseList, 0);
  listOfImages = $.getInterceptor$JSStringJSArray(sds).operator$index$1(sds, "section_images");
  for (t1 = $.getInterceptor$JSArray(listOfImages).iterator$0(listOfImages); t1.get$hasNext() === true;) {
    t2 = t1.next$0();
    imageToAdd = $.AIBSImage$();
    t3 = $.getInterceptor$JSStringJSArray(t2);
    imageToAdd.imageHeight = t3.operator$index$1(t2, "image_height");
    imageToAdd.imageWidth = t3.operator$index$1(t2, "image_width");
    imageToAdd.imagePath = t3.operator$index$1(t2, "path");
    imageToAdd.expressionPath = t3.operator$index$1(t2, "expressionPath");
    imageToAdd.resolution = t3.operator$index$1(t2, "resolution");
    imageToAdd.structureID = t3.operator$index$1(t2, "structure_id");
    imageToAdd.sectionNumber = t3.operator$index$1(t2, "section_number");
    imageToAdd.aibsID = t3.operator$index$1(t2, "id");
    imageToAdd.tierCount = t3.operator$index$1(t2, "tier_count");
    imageToAdd.dataSetID = t3.operator$index$1(t2, "data_set_id");
    this.imageSeriesList.push(imageToAdd);
    this.delegate$0();
  }
},
 get$onSuccess: function() {
  return new $.BoundClosure0(this, 'onSuccess$1');
},
 ImageCollection$2: function(customMessage, delegate) {
  var t1;
  $.print("Initialized new Neurokit class with note: " + $.S(customMessage));
  t1 = $.List_List(null, $.AIBSImage);
  $.setRuntimeTypeInfo(t1, [$.AIBSImage]);
  this.imageSeriesList = t1;
  this.delegate = delegate;
}
};

$$.Viewport = {"":"View;_toolbar,_spacingLeft,_spacingTop,_spacingRight,_spacingBottom,_uuid,_parent,_nextSibling,_prevSibling,_virtIS,_childInfo,_evlInfo,_dataAttrs,_mntAttrs,_annos,_style,_node,_left,_top,_width,_height,_profile,_layout,_inDoc",
 set$title: function(title) {
  var t1 = !(title == null) ? title : "";
  this.getNode$1("title").set$innerHtml(t1);
},
 set$toolbar: function(tbar) {
  ...
  t1 = this._toolbar;
  if (!(t1 == null)) {
    this.addChild$2(t1, this.get$firstChild());
    this._toolbar.set$top(0);
    this._toolbar.set$left(120);
  }
},
 get$contentNode: function() {
  return this.getNode$1("inner");
 ...
 shallLayout_$1: function(child) {
  var t1 = this._toolbar;
  return !(child == null ? t1 == null : child === t1) && $.View.prototype.shallLayout_$1.call(this, child) === true;
},
 render_$0: function() {
  return $.Element_Element$html("<div>\n<div class=\"v-Viewport-title\" id=\"" + $.S(this.get$uuid()) + "-title\"></div>\n<div class=\"v-Viewport-toolbar\" id=\"" + $.S(this.get$uuid()) + "-toolbar\">&nbsp;</div>\n<div class=\"v-Viewport-inner\" id=\"" + $.S(this.get$uuid()) + "-inner\"></div>\n</div>\n      ");
},
 addChildNode_$2: function(child, beforeChild) {
  var t1 = this._toolbar;
  if (child == null ? t1 == null : child === t1) {
    t1 = this.getNode$1("toolbar").get$nodes();
    $.getInterceptor$JSArray(t1).add$1(t1, child.get$node());
  } else if (!(beforeChild == null) && !(beforeChild == null ? t1 == null : beforeChild === t1))
    $.View.prototype.addChildNode_$2.call(this, child, beforeChild);
  else {
    t1 = this.get$contentNode().get$nodes();
    $.getInterceptor$JSArray(t1).add$1(t1, child.get$node());
 ...
 mount_$0: function() {
  ...
  style.set$left($.Css_px(this._spacingLeft));
  style.set$top($.Css_px(this._spacingTop));
  this._adjustWidth$0();
  this._adjustHeight$0();
},
 get$innerWidth: function() {
  return $.DomAgent$(this.get$contentNode()).get$innerWidth();
},
 get$innerHeight: function() {
  return $.DomAgent$(this.get$contentNode()).get$innerHeight();
},
 set$width: function(width) {
 ...
 _adjustWidth$0: function() {
  var v, t1;
  v = $.sub($.sub($.DomAgent$(this.get$node()).get$innerWidth(), this._spacingLeft), this._spacingRight);
  t1 = $.Css_px($.gtB(v, 0) ? v : 0);
  this.get$contentNode().get$style().set$width(t1);
},
 _adjustHeight$0: function() {
  var v, t1;
  v = $.sub($.sub($.DomAgent$(this.get$node()).get$innerHeight(), this._spacingTop), this._spacingBottom);
  t1 = $.Css_px($.gtB(v, 0) ? v : 0);
  this.get$contentNode().get$style().set$height(t1);
},
 Viewport$1: function(title) {
  if (!(title == null) && $.getInterceptor$JSStringJSArray(title).get$isEmpty(title) !== true)
...
$$.main_anon = {"":"Closure;",
 call$1: function(off) {
  var t1, vlimit, y;
  t1 = $.scrollView.get$innerHeight();
  if (typeof t1 !== 'number')
    throw $.iae(t1);
  vlimit = 2500 - t1;
  if ($.geB(off.get$y(), vlimit))
    y = vlimit;
  else {
    t1 = $.div($.add(off.get$y(), 25), 50);
    y = $.mul($.getInterceptor$JSNumber(t1).floor$0(t1), 50);
  }
  return $.Offset$(off.get$x(), y);
}
};
...
$$.ScrollView_newScroller__anon = {"":"Closure;this_0",
 call$0: function() {
  return this.this_0.get$viewPortSize();
}
};

$$.ScrollView_newScroller__anon0 = {"":"Closure;this_1",
 call$0: function() {
...
$$.anon = {"":"Closure;this_0",
 call$1: function(state) {
  return this.this_0._onStart$2(state.get$eventTarget(), state.get$time());
}
};
...
$$.anon0 = {"":"Closure;this_1",
 call$1: function(state) {
  var t1 = this.this_1;
  t1._onMove$2($.sub(state.get$transition(), t1.get$_state().get$startPosition()), state.get$time());
}
};

$$.anon1 = {"":"Closure;this_2,owner_3,snap_4",
 call$1: function(state) {
  var t1, t2, range;
  t1 = this.owner_3;
  $.DomAgent$(t1).get$offset();
  t2 = this.this_2;
  range = t2.get$_state().get$dragRange();
  t1 = $._BoundedInertialMotion$(t1, state.get$velocity(), range, t2.get$_hor(), t2.get$_ver(), t2.get$_onMove(), t2.get$_onEnd(), 0.0002, 0.0005, this.snap_4, 0.05);
  t1.run$0();
  t2.set$_bim(t1);
}
};

$$._TouchDragGesture__listen_anon = {"":"Closure;this_0",
 call$1: function(event$) {
  var t1, t2, t3, t;
  t1 = event$.get$touches();
  t2 = $.gtB($.getInterceptor$JSStringJSArray(t1).get$length(t1), 1);
  t3 = this.this_0;
  if (t2)
    t3._touchEnd$0();
  else {
    t1 = event$.get$touches();
    t = $.getInterceptor$JSStringJSArray(t1).operator$index$1(t1, 0);
...
$$._TouchDragGesture__listen_anon0 = {"":"Closure;this_1",
 call$1: function(event$) {
  var t1, t;
  t1 = event$.get$touches();
  t = $.getInterceptor$JSStringJSArray(t1).operator$index$1(t1, 0);
...
$$._TouchDragGesture__listen_anon1 = {"":"Closure;this_2",
 call$1: function(event$) {
...
$$.ViewEventListenerMap__get_anon = {"":"Closure;this_0,type_1",
 call$0: function() {
  return $.ViewEventListenerList$(this.this_0.get$_liblib3$_ptr(), this.type_1);
}
};
...
$$._MouseDragGesture__listen_anon = {"":"Closure;this_0",
 call$1: function(event$) {
  var t1 = this.this_0;
...
$$._MouseDragGesture__capture_anon = {"":"Closure;this_0",
 call$1: function(event$) {
  this.this_0._touchMove$2($.Offset$(event$.get$pageX(), event$.get$pageY()), event$.get$timeStamp());
}
};

$$._MouseDragGesture__capture_anon0 = {"":"Closure;this_1",
 call$1: function(event$) {
...
$$.anon2 = {"":"Closure;this_0",
 call$1: function(now) {
  ...
  if ($.getInterceptor$JSStringJSArray(t2).get$isEmpty(t2) !== true) {
    ...
    try {
      for (j = 0; t2 = j, t3 = t1.get$_liblib6$_tasks(), $.ltB(t2, $.getInterceptor$JSStringJSArray(t3).get$length(t3)); j = $.add(j, 1)) {
        if (t1._isRemoved$1(j) !== true) {
          t2 = t1.get$_liblib6$_tasks();
          t3 = $.getInterceptor$JSStringJSArray(t2).operator$index$1(t2, j).call$1(inow) !== true;
          t2 = t3;
        } else
          t2 = false;
        if (t2) {
          t2 = t1.get$_liblib6$_tasks();
          $.getInterceptor$JSArray(t2).removeRange$2(t2, j, 1);
          j = $.sub(j, 1);
        }
      }
    } finally {
...
$$.Scroller__onMove_anon = {"":"Closure;this_0,position_1",
 call$0: function() {
  return this.this_0._applyPosition$1(this.position_1);
}
};
...
$$.anon3 = {"":"Closure;this_0",
 call$1: function(time) {
  ...
  if ($.eqB(t1.get$_stateFlag(), 0)) {
    t1.set$_liblib6$_state($.MotionState$_(time, 0, null));
    t1.onStart$1(t1.get$_liblib6$_state());
    t1.set$_stateFlag(1);
  }
  t1.get$_liblib6$_state()._snapshot$1(time);
  switch (t1.get$_stateFlag()) {
    case 1:
      if (t1.get$_liblib6$_state().get$isPaused() === true) {
        t1.get$_liblib6$_state()._resume$1(time);
        t1.onResume$1(t1.get$_liblib6$_state());
      }
      cont = t1.onMove$1(t1.get$_liblib6$_state());
      if (cont == null)
        cont = true;
      if (cont !== true) {
        t1.onEnd$1(t1.get$_liblib6$_state());
        t1.set$_liblib6$_state(null);
        t1.set$_stateFlag(0);
      }
      return cont;
    case 2:
      if (t1.get$_liblib6$_state().get$isPaused() !== true) {
        t1.get$_liblib6$_state()._pause$1(time);
        t1.onPause$1(t1.get$_liblib6$_state());
      }
      return true;
  }
}
...
$$._BoundedInertialMotion_onEnd_anon = {"":"Closure;this_0",
 call$4: function(ms, pos, x, defaultAction) {
  var t1;
  defaultAction.call$0();
  t1 = this.this_0;
  if (!(t1.get$_move() == null))
    t1._move$2(pos, ms.get$currentTime());
}
};

$$._BoundedInertialMotion_onEnd_anon0 = {"":"Closure;this_1",
 call$1: function(ms) {
  var t1 = this.this_1;
  if (!(t1.get$_end() == null))
    t1._end$0();
...
$$._BoundedInertialMotion_onEnd_anon1 = {"":"Closure;",
 call$1: function(x) {
  return $.mul(x, x);
}
};
...
$$.MeasureContext_dataAttributes_anon = {"":"Closure;this_0",
 call$0: function() {
  var t1 = $.Map_Map();
  this.this_0.set$_liblib8$_dataAttrs(t1);
  return t1;
}
};
...
$$.LayoutManager_waitImageLoaded_anon = {"":"Closure;this_0,imgURI_1",
 call$1: function(event$) {
  var t1, t2;
  t1 = this.imgURI_1;
  t2 = this.this_0;
...
$$.BoundClosure4 = {"":"Closure;self,target", call$3: function(p0, p1, p2) {
 ...
 call$2: function(position, time) {
  return this.call$3(position, time, true);
}
};
...
$._HashSetIterator$ = function(set_, E) {
  var t1 = new $._HashSetIterator(set_._backingMap.get$_liblib$_keys(), -1);
  $.setRuntimeTypeInfo(t1, [E]);
...
$.ImageCollection$ = function(customMessage, delegate) {
  var t1 = new $.ImageCollection(null, null, "http://api.brain-map.org/api/v2/data/query.json?criteria=model::SectionDataSet,rma::criteria,products[abbreviation$in'HumanASD','HumanCtx','HumanSubCtx','HumanSZ','HumanNT'],treatments[name$eq'ISH'],specimen[donor_id$eq1312],rma::include,probes(gene),section_images,specimen(donor(age,disease_categories,medical_conditions))");
  t1.ImageCollection$2(customMessage, delegate);
  return t1;
};

$.AIBSImage$ = function() {
  return new $.AIBSImage(null, null, null, null, null, null, null, null, null, null, null, "http://human.brain-map.org/tiles//", "/TileGroup/0-0-0.jpg");
};

$.Viewport$ = function(title) {
  var t1 = new $.Viewport(null, 10, 30, 10, 10, null, null, null, null, null, null, null, null, null, null, null, null, 0, 0, null, null, null, null, false);
  t1.Viewport$1(title);
  return t1;
};
...
$.main = function() {
  var t1, mainView;
  $.viewport = $.Viewport$("NIDASH");
  $.viewport.get$layout().set$type("linear");
  $.viewport.get$layout().set$orient("vertical");
  $.viewport.get$profile().set$height("flex");
  $.viewport.get$profile().set$width("flex");
  $.createToolbar($.viewport);
  $.createExperimentView();
  $.imageCollection = $.ImageCollection$("Example init message passing", $.hasImageData);
  $.imageCollection.queryJSONFromAIBS$0();
  $.scrollView = $.ScrollView$(null, $.CONSTANT, new $.main_anon());
  $.scrollView.get$profile().set$text("location: right top; width: 250px; height: 250px");
  t1 = $.scrollView.get$classes();
  $.getInterceptor$JSArray(t1).add$1(t1, "list-view");
  mainView = $.View$();
  mainView.addToDocument$0();
  mainView.addChild$1($.viewport);
  $.viewport.addChild$1($.scrollView);
};

$.createExperimentView = function() {
  $.experimentView = $.View$();
  $.experimentView.get$style().set$cssText("background:#fff");
  $.experimentView.set$width(300);
  $.experimentView.set$height(300);
  $.viewport.addChild$1($.experimentView);
};

$.hasImageData = function() {
  var t1, x, child, t2;
  for (t1 = $.imageCollection.get$imageSeriesList(), t1 = $.getInterceptor$JSArray(t1).iterator$0(t1), x = 0; t1.get$hasNext() === true;) {
    child = $.TextView$($.S(t1.next$0().get$aibsID()));
    t2 = child.get$classes();
    $.getInterceptor$JSArray(t2).add$1(t2, "list-item");
    child.get$style().set$cssText("line-height: 40px");
    child.get$profile().set$width("flex");
    child.set$top(x * 40);
    child.set$height(40);
    t2 = child.get$on().get$click();
    $.getInterceptor$JSArray(t2).add$1(t2, $.selectRowWithPath);
    $.scrollView.addChild$1(child);
    ++x;
  }
  $.scrollView.requestLayout$2(true, false);
};

$.selectRowWithPath = function(event$) {
  $.print(event$.get$target().get$text());
};

$.createToolbar = function(parent$) {
  var toolbar$, t1, i, imgToAdd, t2;
  toolbar$ = $.View$();
  toolbar$.get$layout().set$type("linear");
  toolbar$.get$profile().set$width("content");
  toolbar$.get$profile().set$height("content");
  for (t1 = $.CONSTANT0.iterator$0(["01-refresh.png", "06-magnify.png", "07-map-marker.png"]), i = 0; t1.get$hasNext() === true;) {
    imgToAdd = $.Image$("res/icons/icons-white/" + $.S(t1.next$0()));
    $.indexSet(imgToAdd.get$dataAttributes(), "test", i);
    t2 = imgToAdd.get$on().get$click();
    $.getInterceptor$JSArray(t2).add$1(t2, $.buttonTapHandler);
    toolbar$.addChild$1(imgToAdd);
    ++i;
  }
  parent$.set$toolbar(toolbar$);
};
...
$.LinearPathMotion$ = function(element, origin, destination, easing, end, move, period, start) {
  var t1 = $.sub(destination, origin);
  if (typeof period !== 'number')
    throw $.iae(period);
  t1 = new $.LinearPathMotion(element, move, origin, destination, t1, null, null, easing, period, 1, 1 * period, start, null, end, null, null, 0);
...
$.ScrollEvent$ = function(type, target, state) {
  var t1 = new $.ScrollEvent(state, type, $.Date_Date$now().get$millisecondsSinceEpoch(), false, null, null);
  t1.ViewEvent$2(type, target);
  return t1;
};
...
$.Scroller$ = function(owner, viewPortSize, contentSize, direction, end, handle, move, scrollbar, snap, start) {
  var t1, t2;
  t1 = direction === $.CONSTANT8 || direction === $.CONSTANT9;
  t2 = direction === $.CONSTANT || direction === $.CONSTANT9;
  t2 = new $.Scroller(t1, t2, scrollbar, start, move, end, contentSize, viewPortSize, null, null, null, null, null, direction, owner, handle);
  t2.Scroller$10$direction$end$handle$move$scrollbar$snap$start(owner, viewPortSize, contentSize, direction, end, handle, move, scrollbar, snap, start);
  return t2;
};

$.ScrollerState$_ = function(scroller, eventTarget, _fnViewPortSize, _fnContentSize, _time) {
  var t1 = new $.ScrollerState(_fnViewPortSize, _fnContentSize, null, null, null, null, _time, null, null, null, null, eventTarget, scroller, $.mul($.DomAgent$(scroller.owner).get$offset(), -1), null);
  t1.ScrollerState$_$5(scroller, eventTarget, _fnViewPortSize, _fnContentSize, _time);
  return t1;
};

$.ScrollbarControl$ = function(scroller, owner) {
  return new $.ScrollbarControl(null, null, scroller, owner);
};

$._BoundedInertialMotion$ = function(element, velocity, range, _hor, _ver, move, end, bounce, friction, snap, snapSpeedThreshold) {
  var t1 = new $._BoundedInertialMotion(_hor, _ver, element, friction, bounce, snapSpeedThreshold, range, move, end, snap, null, null, null, null, null, null, null, null, null, null, null, 0);
  t1.Motion$3$end$move$start(null, null, null);
  t1._BoundedInertialMotion$11$bounce$friction$snap$snapSpeedThreshold(element, velocity, range, _hor, _ver, move, end, bounce, friction, snap, snapSpeedThreshold);
  return t1;
};
...
$.locateToView = function(mctx, view, location$, anchor, x, y) {
  ...
  if (!(anchor == null)) {
    ...
    t2 = $.getInterceptor$JSStringJSArray(t1);
    t3 = $.getInterceptor$JSStringJSArray(locators);
    t2.operator$index$1(t1, t3.operator$index$1(locators, 0)).call$3($.add(x, mi.left), $.CONSTANT23, view);
    t4 = $.get$_anchorYLocators();
    $.getInterceptor$JSStringJSArray(t4).operator$index$1(t4, t3.operator$index$1(locators, 1)).call$3($.add(y, mi.top), $.CONSTANT23, view);
  }
...
$._getLocators = function(loc) {
  ...
  if ($.getInterceptor$JSStringJSArray(loc).get$isEmpty(loc) === true)
    loc = "top left";
  locators = $.CONSTANT22.operator$index$1(loc);
  if (!(locators == null))
    return locators;
  t1 = $.getInterceptor$JSStringJSArray(loc);
  j = t1.indexOf$1(loc, " ");
  if ($.gtB(j, 0)) {
    locators = $.CONSTANT22.operator$index$1($.S(t1.substring$1(loc, $.add(j, 1))) + " " + $.S(t1.substring$2(loc, 0, j)));
    if (!(locators == null))
      return locators;
  }
...
$._getAmountInfo = function(view, value) {
  ...
  if ($.eqB(amt.type, $.CONSTANT17) && view.get$layout().get$handler().get$isFlex() === true) {
    amt.type = $.CONSTANT20;
    amt.value = 1;
  }
  return amt;
...
$.rootLayout = function(mctx, root) {
  ...
  if (!leftByApp || !topByApp) {
    ...
    if (t3)
      ...
      ref = !t1 ? $._AnchorOfNode$(cave) : $.CONSTANT15;
    if (t3)
...
$.ScrollView$ = function(contentSize, direction, snap) {
  return new $.ScrollView(snap, direction, null, contentSize, contentSize, null, null, null, null, null, null, null, null, null, null, null, null, 0, 0, null, null, null, null, false);
};
...
$.ViewUtil_getRectangle = function(children) {
  var t1, bottom, left, top$, right, t2, pos, val, t3;
  for (t1 = $.getInterceptor$JSArray(children).iterator$0(children), bottom = 0, left = 0, top$ = 0, right = 0; t1.get$hasNext() === true;) {
    t2 = t1.next$0();
    if ((t2.get$parent() == null || t2.get$parent().shallLayout_$1(t2) === true) && t2.get$profile().get$anchorView() == null) {
      pos = t2.get$style().get$position();
      if (!$.eqB(pos, "static") && !$.eqB(pos, "fixed")) {
        if ($.ltB(t2.get$left(), left))
          left = t2.get$left();
        val = t2.get$width();
        if (!(val == null)) {
...
$._domEvtTarget = function(type, node) {
  var t1, t2, t3, t4, inp;
  if ($.CONSTANT0.contains$1($.CONSTANT10, type) === true) {
    t1 = $.get$_inpTags();
    t2 = $.getInterceptor$JSStringJSArray(t1);
    t3 = node.get$tagName();
...
$._domEventDispatcher = function(type) {
  ...
  if ($._domEvtDisps == null) {
    ...
    for (t1 = $.CONSTANT0.iterator$0($.CONSTANT12); t1.get$hasNext() === true;) {
      t2 = t1.next$0();
      $.indexSet($._domEvtDisps, t2, $._domEvtDisp(t2));
    }
    for (t1 = $.CONSTANT0.iterator$0($.CONSTANT10); t1.get$hasNext() === true;) {
      t2 = t1.next$0();
      $.indexSet($._domEvtDisps, t2, $._domEvtDisp(t2));
    }
...
$.ViewIterator__getCommonSeqLength = function(list) {
  var t1, max, strs, t2, t3, id, i, t4, i0, t5;
  for (t1 = $.getInterceptor$JSArray(list).iterator$0(list), max = 0, strs = null; t1.get$hasNext() === true;) {
    t2 = t1.next$0();
    if (strs == null) {
...
$.Rectangle$ = function(left, top$, right, bottom) {
  return new $.Rectangle(right, bottom, left, top$);
};
...
$.StringUtil_addCharCodes = function(src, diff) {
  ...
  for (; --j, j >= 0;)
    dst[j] = $.add($.CONSTANT3.charCodeAt$1(src, j), diff);
...
$.XmlUtil_encode = function(txt, maxlength, multiline, pre) {
  ...
  if (multiline || t2)
    for (t3 = $.getInterceptor$JSArray(out), j = 0, k = 0; j < tl; ++j) {
      ...
      enc = $.CONSTANT24.operator$index$1(cc);
      if (!(enc == null)) {
    ...
    for (t2 = $.getInterceptor$JSArray(out), j = 0, k = 0; j < tl; ++j) {
      if (j >= txt.length)
        throw $.ioore(j);
      enc = $.CONSTANT24.operator$index$1(txt[j]);
      if (!(enc == null)) {
    ...
    case 3:
      ...
      if (state0 === 3 || state0 === 0 && (multiline || t2))
        ...
        for (t2 = $.getInterceptor$JSArray(out), j = 0, k = 0; $.ltB(j, tl); ++j) {
          enc = $.CONSTANT24.operator$index$1(t1.operator$index$1(txt, j));
          if (!(enc == null)) {
            t2.add$1(out, t1.substring$2(txt, k, j));
            t2.add$1(out, "&");
            t2.add$1(out, enc);
...
$.hasImageData.call$0 = $.hasImageData;
$.hasImageData.$name = "hasImageData";
$.selectRowWithPath.call$1 = $.selectRowWithPath;
$.selectRowWithPath.$name = "selectRowWithPath";
$.buttonTapHandler.call$1 = $.buttonTapHandler;
$.buttonTapHandler.$name = "buttonTapHandler";
...
$.CONSTANT4 = new Isolate.$isolateProperties.ConstantMap(0, {}, Isolate.$isolateProperties.CONSTANT14);
$.CONSTANT13 = new Isolate.$isolateProperties.JSDouble();
$.CONSTANT26 = Isolate.makeConstantList([2, 0]);
$.CONSTANT27 = Isolate.makeConstantList([3, 0]);
$.CONSTANT28 = Isolate.makeConstantList([1, 0]);
$.CONSTANT29 = Isolate.makeConstantList([3, 4]);
$.CONSTANT30 = Isolate.makeConstantList([2, 4]);
$.CONSTANT31 = Isolate.makeConstantList([4, 3]);
$.CONSTANT32 = Isolate.makeConstantList([1, 4]);
$.CONSTANT33 = Isolate.makeConstantList([0, 2]);
$.CONSTANT34 = Isolate.makeConstantList([0, 3]);
$.CONSTANT = new Isolate.$isolateProperties.Dir("vertical");
$.CONSTANT35 = Isolate.makeConstantList([4, 1]);
$.CONSTANT36 = Isolate.makeConstantList([4, 2]);
$.CONSTANT37 = Isolate.makeConstantList([3, 1]);
$.CONSTANT38 = Isolate.makeConstantList([2, 1]);
$.CONSTANT15 = new Isolate.$isolateProperties._AnchorOfRoot();
$.CONSTANT39 = Isolate.makeConstantList([1, 1]);
$.CONSTANT40 = Isolate.makeConstantList([0, 1]);
$.CONSTANT41 = Isolate.makeConstantList([1, 3]);
$.CONSTANT18 = new Isolate.$isolateProperties.AmountType("ignore");
$.CONSTANT42 = Isolate.makeConstantList(["<", ">", "&", "\""]);
$.CONSTANT24 = new Isolate.$isolateProperties.ConstantMap(4, {"<": "lt", ">": "gt", "&": "amp", "\"": "quot"}, Isolate.$isolateProperties.CONSTANT42);
$.CONSTANT19 = new Isolate.$isolateProperties.AmountType("content");
$.CONSTANT43 = Isolate.makeConstantList([3, 3]);
$.CONSTANT44 = Isolate.makeConstantList([3, 2]);
$.CONSTANT23 = new Isolate.$isolateProperties._AnchorOfPoint();
$.CONSTANT45 = Isolate.makeConstantList([1, 2]);
$.CONSTANT1 = new Isolate.$isolateProperties.NullThrownError();
$.CONSTANT46 = Isolate.makeConstantList([2, 2]);
$.CONSTANT47 = Isolate.makeConstantList([2, 3]);
$.CONSTANT48 = Isolate.makeConstantList(["north start", "north center", "north end", "south start", "south center", "south end", "west start", "west center", "west end", "east start", "east center", "east end", "top left", "top center", "top right", "center left", "center center", "center right", "bottom left", "bottom center", "bottom right"]);
$.CONSTANT22 = new Isolate.$isolateProperties.ConstantMap(21, {"north start": Isolate.$isolateProperties.CONSTANT28, "north center": Isolate.$isolateProperties.CONSTANT26, "north end": Isolate.$isolateProperties.CONSTANT27, "south start": Isolate.$isolateProperties.CONSTANT32, "south center": Isolate.$isolateProperties.CONSTANT30, "south end": Isolate.$isolateProperties.CONSTANT29, "west start": Isolate.$isolateProperties.CONSTANT40, "west center": Isolate.$isolateProperties.CONSTANT33, "west end": Isolate.$isolateProperties.CONSTANT34, "east start": Isolate.$isolateProperties.CONSTANT35, "east center": Isolate.$isolateProperties.CONSTANT36, "east end": Isolate.$isolateProperties.CONSTANT31, "top left": Isolate.$isolateProperties.CONSTANT39, "top center": Isolate.$isolateProperties.CONSTANT38, "top right": Isolate.$isolateProperties.CONSTANT37, "center left": Isolate.$isolateProperties.CONSTANT45, "center center": Isolate.$isolateProperties.CONSTANT46, "center right": Isolate.$isolateProperties.CONSTANT44, "bottom left": Isolate.$isolateProperties.CONSTANT41, "bottom center": Isolate.$isolateProperties.CONSTANT47, "bottom right": Isolate.$isolateProperties.CONSTANT43}, Isolate.$isolateProperties.CONSTANT48);
$.CONSTANT21 = new Isolate.$isolateProperties.AmountType("ratio");
$.CONSTANT20 = new Isolate.$isolateProperties.AmountType("flex");
$.CONSTANT16 = new Isolate.$isolateProperties.AmountType("fixed");
$.CONSTANT17 = new Isolate.$isolateProperties.AmountType("none");
$.CONSTANT12 = Isolate.makeConstantList(["abort", "click", "dblclick", "drag", "dragEnd", "dragEnter", "dragLeave", "dragOver", "dragStart", "drop", "error", "keyDown", "keyPress", "keyUp", "load", "mouseDown", "mouseMove", "mouseOut", "mouseOver", "mouseUp", "mouseWheel", "reset", "scroll", "select", "submit", "unload"]);
$.CONSTANT10 = Isolate.makeConstantList(["focus", "blur"]);
$.CONSTANT5 = new Isolate.$isolateProperties._DeletedKeySentinel();
$.CONSTANT49 = Isolate.makeConstantList(["body", "head", "caption", "td", "colgroup", "col", "tr", "tbody", "tfoot", "thead", "track"]);
$.CONSTANT7 = new Isolate.$isolateProperties.ConstantMap(11, {body: "html", head: "html", caption: "table", td: "tr", colgroup: "table", col: "colgroup", tr: "tbody", tbody: "table", tfoot: "table", thead: "table", track: "audio"}, Isolate.$isolateProperties.CONSTANT49);
$.CONSTANT25 = new Isolate.$isolateProperties.Object();
$.CONSTANT9 = new Isolate.$isolateProperties.Dir("both");
$.CONSTANT8 = new Isolate.$isolateProperties.Dir("horizontal");
$.CONSTANT11 = Isolate.makeConstantList(["input", "textarea", "select", "button", "a"]);
...
$.experimentView = null;
$._anchorOfRoot = Isolate.$isolateProperties.CONSTANT15;
$.ScrollbarControl__mgs = 2;
$.ScrollbarControl__bds = 1;
$.ScrollbarControl__ins = 4;
$.AmountType_NONE = Isolate.$isolateProperties.CONSTANT17;
$.AmountType_FIXED = Isolate.$isolateProperties.CONSTANT16;
$.AmountType_RATIO = Isolate.$isolateProperties.CONSTANT21;
$.AmountType_FLEX = Isolate.$isolateProperties.CONSTANT20;
$.AmountType_CONTENT = Isolate.$isolateProperties.CONSTANT19;
$._HashMapImpl__DELETED_KEY = Isolate.$isolateProperties.CONSTANT5;
$._locators = Isolate.$isolateProperties.CONSTANT22;
$._HashMapImpl__INITIAL_CAPACITY = 8;
$.Selectors_STATE_PRE_SLCT = 1;
$.Selectors_STATE_IN_SLCT = 9;
$.Selectors_STATE_POST_SLCT = 14;
$._anchorOfPoint = Isolate.$isolateProperties.CONSTANT23;
$.View__mntCnt = 0;
...
$.AmountType_IGNORE = Isolate.$isolateProperties.CONSTANT18;
$.Selectors_TOKEN_CLASS_LITERAL = 0;
$.Dir_VERTICAL = Isolate.$isolateProperties.CONSTANT;
$.Selectors_TOKEN_CLASS_WHITESPACE = 1;
$.Dir_HORIZONTAL = Isolate.$isolateProperties.CONSTANT8;
$.Selectors_TOKEN_CLASS_OTHER = 2;
$.Dir_BOTH = Isolate.$isolateProperties.CONSTANT9;
$.XmlUtil__encs = Isolate.$isolateProperties.CONSTANT24;
...
$.EMPTY_LIST = Isolate.$isolateProperties.CONSTANT14;
$.EMPTY_MAP = Isolate.$isolateProperties.CONSTANT4;
$.HttpRequest_DONE = 4;
$.ViewUtil__appId = null;
$.ViewUtil__APP_COUNT = "data-rkAppCount";
$._noBubEvts = Isolate.$isolateProperties.CONSTANT10;
...
Isolate.$lazy($, '_inpTags', '_inpTags', 'get$_inpTags', function() {
  return $.Set_Set$from($.CONSTANT11);
});
Isolate.$lazy($, '_CC_z', '_CC_z', 'get$_CC_z', function() {
  return $.add($.get$_CC_a(), 25);
});
...
$.$defineNativeClass('Element', {"":"$$dom_children:children~,id=,innerHtml:innerHTML|,$$dom_className:className},clientHeight>,clientWidth>,$$dom_firstElementChild:firstElementChild~,$$dom_lastElementChild:lastElementChild~,nextElementSibling>,offsetHeight>,offsetLeft>,offsetParent>,offsetTop>,offsetWidth>,scrollHeight>,scrollLeft>,scrollTop>,scrollWidth>,style>,tagName>",
 ...
 set$classes: function(value) {
  if (Object.getPrototypeOf(this).hasOwnProperty('set$classes')) {
    var classSet, t1;
    classSet = this.get$classes();
    t1 = $.getInterceptor$JSArray(classSet);
    t1.clear$0(classSet);
...
$.$defineNativeClass('HTMLMediaElement', {"":"currentTime>,error>,readyState>,src=",
 get$on: function() {
...
$.$defineNativeClass('Node', {"":"$$dom_attributes:attributes~,$$dom_childNodes:childNodes~,$$dom_localName:localName~,$$dom_namespaceUri:namespaceURI~,nextNode:nextSibling~,parent:parentElement~,text:textContent}",
 get$nodes: function() {
...
$.$defineNativeClass('PopStateEvent', {"":"_liblib1$_state:state~"
});
...
// 23 !leaf
(function() {
  var v0_MouseEvent = 'MouseEvent|WheelEvent', v1_TextPositioningElement = 'SVGTextPositioningElement|SVGAltGlyphElement|SVGTRefElement|SVGTSpanElement|SVGTextElement', v2_ComponentTransferFunctionElement = 'SVGComponentTransferFunctionElement|SVGFEFuncRElement|SVGFEFuncAElement|SVGFEFuncGElement|SVGFEFuncBElement', v3_MediaElement = 'HTMLMediaElement|HTMLVideoElement|HTMLAudioElement', v4_SvgElement = [v1_TextPositioningElement, v2_ComponentTransferFunctionElement, 'SVGElement|SVGAElement|SVGAltGlyphDefElement|SVGTextContentElement|SVGTextPathElement|SVGAltGlyphItemElement|SVGAnimationElement|SVGAnimateColorElement|SVGAnimateElement|SVGAnimateMotionElement|SVGAnimateTransformElement|SVGSetElement|SVGCircleElement|SVGClipPathElement|SVGDefsElement|SVGCursorElement|SVGEllipseElement|SVGFEBlendElement|SVGFECompositeElement|SVGFEDisplacementMapElement|SVGFEComponentTransferElement|SVGDescElement|SVGFEColorMatrixElement|SVGFEDistantLightElement|SVGFEDiffuseLightingElement|SVGFEMergeNodeElement|SVGFEDropShadowElement|SVGFEMorphologyElement|SVGFEGaussianBlurElement|SVGFEImageElement|SVGFESpecularLightingElement|SVGFESpotLightElement|SVGFontElement|SVGFEFloodElement|SVGFEMergeElement|SVGFETileElement|SVGFontFaceNameElement|SVGFEPointLightElement|SVGGlyphElement|SVGForeignObjectElement|SVGGradientElement|SVGLinearGradientElement|SVGRadialGradientElement|SVGFETurbulenceElement|SVGImageElement|SVGHKernElement|SVGGlyphRefElement|SVGFontFaceElement|SVGFontFaceFormatElement|SVGFilterElement|SVGFEConvolveMatrixElement|SVGGElement|SVGMetadataElement|SVGMaskElement|SVGFontFaceSrcElement|SVGFontFaceUriElement|SVGFEOffsetElement|SVGPathElement|SVGMarkerElement|SVGMPathElement|SVGMissingGlyphElement|SVGLineElement|SVGPatternElement|SVGPolygonElement|SVGPolylineElement|SVGRectElement|SVGScriptElement|SVGStopElement|SVGStyleElement|SVGSVGElement|SVGSwitchElement|SVGSymbolElement|SVGTitleElement|SVGUseElement|SVGVKernElement|SVGViewElement'].join('|'), v5_UIEvent = [v0_MouseEvent, 'UIEvent|SVGZoomEvent|CompositionEvent|KeyboardEvent|TextEvent|TouchEvent'].join('|'), v6_Text = 'Text|CDATASection', v7_Element = [v3_MediaElement, v4_SvgElement, 'Element|HTMLUListElement|HTMLUnknownElement|HTMLElement|HTMLAnchorElement|HTMLAppletElement|HTMLAreaElement|HTMLBaseElement|HTMLBRElement|HTMLBaseFontElement|HTMLBodyElement|HTMLButtonElement|HTMLCanvasElement|HTMLContentElement|HTMLDListElement|HTMLDataListElement|HTMLDetailsElement|HTMLDirectoryElement|HTMLDivElement|HTMLEmbedElement|HTMLFieldSetElement|HTMLFontElement|HTMLFormElement|HTMLFrameElement|HTMLFrameSetElement|HTMLHRElement|HTMLHeadElement|HTMLHeadingElement|HTMLHtmlElement|HTMLIFrameElement|HTMLImageElement|HTMLInputElement|HTMLKeygenElement|HTMLLIElement|HTMLLabelElement|HTMLLegendElement|HTMLLinkElement|HTMLMapElement|HTMLMarqueeElement|HTMLMenuElement|HTMLMetaElement|HTMLMeterElement|HTMLModElement|HTMLOListElement|HTMLObjectElement|HTMLOptGroupElement|HTMLOptionElement|HTMLOutputElement|HTMLParagraphElement|HTMLParamElement|HTMLPreElement|HTMLProgressElement|HTMLQuoteElement|HTMLScriptElement|HTMLSelectElement|HTMLShadowElement|HTMLSourceElement|HTMLSpanElement|HTMLStyleElement|HTMLTableCaptionElement|HTMLTableCellElement|HTMLTableColElement|HTMLTableElement|HTMLTableRowElement|HTMLTableSectionElement|HTMLTextAreaElement|HTMLTitleElement|HTMLTrackElement'].join('|'), v8_CharacterData = [v6_Text, 'CharacterData|Comment'].join('|'), v9_Document = 'Document|SVGDocument|HTMLDocument', v10_DocumentFragment = 'DocumentFragment|ShadowRoot', v11_Node = [v7_Element, v8_CharacterData, v9_Document, v10_DocumentFragment, 'Node|Attr|DocumentType|EntityReference|Notation|ProcessingInstruction'].join('|');
  $.dynamicSetMetadata([['MouseEvent', v0_MouseEvent], ['UIEvent', v5_UIEvent], ['Uint8Array', 'Uint8Array|Uint8ClampedArray'], ['HTMLMediaElement', v3_MediaElement], ['SVGTextPositioningElement', v1_TextPositioningElement], ['SVGComponentTransferFunctionElement', v2_ComponentTransferFunctionElement], ['SVGElement', v4_SvgElement], ['Element', v7_Element], ['Event', [v5_UIEvent, 'Event|WebGLContextEvent|IDBVersionChangeEvent|IDBVersionChangeEvent|WebKitAnimationEvent|CustomEvent|DeviceMotionEvent|DeviceOrientationEvent|BeforeLoadEvent|CloseEvent|ErrorEvent|HashChangeEvent|AudioProcessingEvent|OfflineAudioCompletionEvent|ProgressEvent|XMLHttpRequestProgressEvent|MediaKeyEvent|MediaStreamEvent|MediaStreamTrackEvent|MessageEvent|MutationEvent|OverflowEvent|PageTransitionEvent|PopStateEvent|RTCDataChannelEvent|RTCIceCandidateEvent|SpeechInputEvent|SpeechRecognitionError|SpeechRecognitionEvent|StorageEvent|TrackEvent|WebKitTransitionEvent'].join('|')], ['Text', v6_Text], ['CharacterData', v8_CharacterData], ['Document', v9_Document], ['DocumentFragment', v10_DocumentFragment], ['Node', v11_Node], ['EventTarget', [v11_Node, 'EventTarget|DOMWindow|XMLHttpRequest|XMLHttpRequestUpload'].join('|')], ['HTMLCollection', 'HTMLCollection|HTMLFormControlsCollection|HTMLOptionsCollection'], ['NodeList', 'NodeList|RadioNodeList'], ['Blob', 'Blob|File'], ['CSSRule', 'CSSRule|CSSCharsetRule|CSSFontFaceRule|CSSUnknownRule|WebKitCSSKeyframesRule|CSSMediaRule|CSSPageRule|CSSStyleRule|CSSImportRule|WebKitCSSKeyframeRule']]);
})();
...
//@ sourceMappingURL=imageViewer.dart.js.map